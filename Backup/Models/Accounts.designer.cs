...
namespace MTGCards.Models
{
    ...
    partial void OnLoginHashChanging(string value);
    partial void OnLoginHashChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LoginHash", DbType="Char(32) NOT NULL", CanBeNull=false)]
		public string LoginHash
		{
			get
			{
				return this._LoginHash;
			}
			set
			{
				if ((this._LoginHash != value))
				{
					this.OnLoginHashChanging(value);
					this.SendPropertyChanging();
					this._LoginHash = value;
					this.SendPropertyChanged("LoginHash");
					this.OnLoginHashChanged();
				}
			}
		}
